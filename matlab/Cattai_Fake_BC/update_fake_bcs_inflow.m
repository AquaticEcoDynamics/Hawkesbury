...
[snum,sstr] = xlsread('../../data/Cattai/212059_CattaiCreek_MurphysBridge/csv.w00077.20210416054326.212059.csv','A12:D20000');
...
data.Q_m3s = [];
data.Q_m3s = interp1(dat.mDate,dat.H,data.Date);


fid = fopen('Inflow_v2.csv','wt');
