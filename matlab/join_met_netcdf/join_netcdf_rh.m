...
basename = 'Reprojected_Modified_JBFA516397_av_rh_scrn_calculated';
...
% The Var
netcdf.putAtt(ncid,u_varid,'units','fraction from 0-1');
netcdf.putAtt(ncid,u_varid,'long_name','av_rh_scrn');
