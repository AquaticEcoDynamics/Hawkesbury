...
for i = 2:length(years)
    ...
    site = ['nc',num2str(i)];
    filename = ['Reprojected_Modified_JBFA516397_av_temp_scrn_',num2str(years(i)),'.nc'];
...
% The Var
netcdf.putAtt(ncid,u_varid,'units','K');
netcdf.putAtt(ncid,u_varid,'long_name','av_temp_scrn');
